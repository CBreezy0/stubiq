...
class MarketListing(TimestampMixin, Base):
    ...
    best_sell_price: Mapped[Optional[int]] = mapped_column(Integer, index=True, nullable=True)
    best_buy_price: Mapped[Optional[int]] = mapped_column(Integer, index=True, nullable=True)
    ...
    roi_percent: Mapped[Optional[float]] = mapped_column(Float, index=True, nullable=True)
